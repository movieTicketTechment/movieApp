...
import com.techment.repository.ImageRepository;
...
public class ImageUploadController {
	...
	@GetMapping(path = { "/getById/{imageId}" })
	public ImageModel getImageById(@PathVariable("imageId") int imageId) throws IOException {
