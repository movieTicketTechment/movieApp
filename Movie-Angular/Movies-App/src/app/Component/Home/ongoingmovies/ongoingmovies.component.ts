...
@Component({
  selector: 'app-ongoingmovies',
  templateUrl: './ongoingmovies.component.html',
  styleUrls: ['./ongoingmovies.component.css']
})
export class OngoingmoviesComponent implements OnInit {
